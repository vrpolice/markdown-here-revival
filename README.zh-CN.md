...
Thunderbird 152 于 2026 年 6 月发布，是 Thunderbird 151 之后的下一个版本。第二代项目将 `strict_max_version` 限制在了 `150.*`，导致无法在 Thunderbird 151 及以上版本安装。

本项目已更新版本兼容性以支持 **Thunderbird 151 与 152**，让有需要的用户能够继续使用。
